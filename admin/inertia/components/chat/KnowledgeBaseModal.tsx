    ...
    openModal(
      ...
      >
        <p className='text-text-primary'>
          This will scan RoachNet's storage directories for any new files and queue them for processing. This is useful if you've manually added files to storage or want to ensure everything is up to date.
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-desert-stone">
                      When you upload documents to your Knowledge Base, RoachNet processes and embeds
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-desert-stone">
                      RoachNet includes built-in Optical Character Recognition (OCR) capabilities,
                      ...
                      format, RoachNet can still process and embed their content for AI access.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-desert-stone">
                      RoachNet will automatically discover and extract any content you save to your
